...
function code_generator() {
  ...
  var _wug_community = "modify sys snmp communities replace-all-with { smart { community-name smart } }";
  var _wug_servers = "modify sys snmp allowed-addresses replace-all-with { 35.8.6.6 35.8.6.7 35.8.6.5 35.8.6.9 35.8.2.60 }";
  var _wug_trap1 = "modify sys snmp traps add { i35_8_6_5 { community smart host 35.8.6.5 } }";
  var _wug_trap2 = "modify sys snmp traps add { i35_8_6_6 { community smart host 35.8.6.6 } }";
  var _wug_trap3 = "modify sys snmp traps add { i35_8_6_7 { community smart host 35.8.6.7 } }";
  var _wug_trap4 = "modify sys snmp traps add { i35_8_6_9 { community smart host 35.8.6.9 } }";
  ...
  device_a = device_a + _splunk_servers + "\r\n";
  device_a = device_a + _wug_community + "\r\n";
  device_a = device_a + _wug_servers + "\r\n";
  device_a = device_a + _wug_trap1 + "\r\n";
  device_a = device_a + _wug_trap2 + "\r\n";
  device_a = device_a + _wug_trap3 + "\r\n";
  device_a = device_a + _wug_trap4 + "\r\n";
  ...
  device_b = device_b + _splunk_servers + "\r\n";
  device_b = device_b + _wug_community + "\r\n";
  device_b = device_b + _wug_servers + "\r\n";
  device_b = device_b + _wug_trap1 + "\r\n";
  device_b = device_b + _wug_trap2 + "\r\n";
  device_b = device_b + _wug_trap3 + "\r\n";
  device_b = device_b + _wug_trap4 + "\r\n";
  ...
  device_b = device_b + _sys_save + "\r\n";
  device_b = device_b + _trust_domain_peer + "\r\n";
  device_b = device_b + _config_sync_create + "\r\n";
  device_b = device_b + _config_sync_init + "\r\n";
  device_b = device_b + _sys_save + "\r\n";
  ...
  device_b = device_b.replace(/\$F5_IP_PEER_MGMT/gi, _device_a_mgmt_ip);
  device_b = device_b.replace(/\$F5_CONFIG_SYNC_GROUP/gi, config_sync_group);
